package com.kalyan.journalApp.config;
        ...
        return new OpenAPI()
                .info(
                        new Info().title("Journal App API")
                                .version("1.0.0")
                                .description("API documentation for the Journal App, providing endpoints for user management, journal entries, and more.")
